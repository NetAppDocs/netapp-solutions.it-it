...
Seguire queste istruzioni per configurare il nodo di controllo Ansible per le macchine RedHat o CentOS: link:../automation/automation_rhel_centos_setup.html["RedHat/CentOS Ansible Controller Setup"^].
Seguire queste istruzioni per configurare il nodo di controllo Ansible per le macchine Ubuntu o Debian: link:../automation/automation_ubuntu_debian_setup.html["Installazione di Ubuntu/Debian Ansible Controller"^].
