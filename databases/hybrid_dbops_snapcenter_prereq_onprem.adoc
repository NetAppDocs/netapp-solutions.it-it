...
link:hybrid_dbops_snapcenter_prerequisite.html["Precedente: Prerequisiti per la configurazione."]
...
link:https://https://docs.netapp.com/us-en/snapcenter/install/concept_snapcenter_standard_capacity_based_licenses.html["Licenze standard SnapCenter basate sulla capacità"^]
...
Seguire queste istruzioni per configurare il nodo di controllo Ansible per le macchine RedHat o CentOS: link:https://review.docs.netapp.com/us-en/netapp-solutions_acao_snapctr/automation/automation_rhel_centos_setup.html["RedHat/CentOS Ansible Controller Setup"^]. Seguire queste istruzioni per configurare il nodo di controllo Ansible per le macchine Ubuntu o Debian: link:https://review.docs.netapp.com/us-en/netapp-solutions_acao_snapctr/automation/automation_ubuntu_debian_setup.html["Installazione di Ubuntu/Debian Ansible Controller"^].

link:hybrid_dbops_snapcenter_prereq_cloud.html["Successivo: Cloud pubblico."]
