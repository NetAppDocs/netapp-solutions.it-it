...
link:aws_ora_fsx_ec2_architecture.html["Precedente: Architettura della soluzione."]
...
+
image:aws_ora_fsx_ec2_stor_12.PNG["Errore: Immagine grafica mancante"]
...
+
image:aws_ora_fsx_ec2_stor_13.PNG["Errore: Immagine grafica mancante"]
...
+
image:aws_ora_fsx_ec2_nfs_01.PNG["Errore: Immagine grafica mancante"]
...
link:aws_ora_fsx_ec2_procedures.html["Avanti: Procedure di implementazione."]
