...
|===
Per informazioni dettagliate, fare riferimento a requisiti di spazio e dimensionamento (https://docs.netapp.com/us-en/snapcenter/install/reference_space_and_sizing_requirements.html)[]
