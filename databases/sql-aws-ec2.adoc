...
+
* Configurare cinque sessioni iSCSI per l'interfaccia di destinazione per ottenere prestazioni ottimali.
* Configurare un criterio round-robin per ottenere le migliori prestazioni complessive di iSCSI.
