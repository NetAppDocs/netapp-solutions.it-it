...
Il seguente toolkit di automazione contiene un playbook che può essere utilizzato per creare o aggiornare cloni di un Oracle VLDB da una copia dell'immagine di backup del database primario archiviata nello storage GCNV tramite montaggio NFS per una gestione completa del ciclo di vita del clone.
