...
Il test e la convalida di questa soluzione sono stati eseguiti in un ambiente AWS FSX ONTAP ed EC2 che potrebbe non corrispondere all'ambiente di implementazione finale. Per ulteriori informazioni, vedere la sezione <<Key Factors for Deployment Consideration>>.
...
Documentazione: link:https://docs.netapp.com/us-en/netapp-solutions/databases/marketing_overview.html#awxtower-deployments["Implementazione automatica di Oracle19c per ONTAP su NFS"^]
