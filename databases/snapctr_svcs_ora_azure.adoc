...
. Rivedi e *Aggiungi*. Immagine::snapctr_svcs_credential_04-Azure.png["schermata che mostra questo passaggio nella GUI."]
. Potrebbe inoltre essere necessario associare un abbonamento *Marketplace* alla credenziale. Immagine::snapctr_svcs_credential_05-Azure.png["schermata che mostra questo passaggio nella GUI."]
...
+
image::snapctr_svcs_restore_01-azure.png[snapctr svcs ripristinare 01 azure]
