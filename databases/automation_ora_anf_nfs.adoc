...
[%collapsible]
====
La migrazione del database Oracle da ambienti on-premise al cloud richiede un lavoro pesante. L'adozione della strategia e dell'automazione giuste può agevolare il processo e ridurre al minimo interruzioni del servizio e downtime. Seguire queste istruzioni dettagliate link:https://docs.netapp.com/us-en/netapp-solutions/databases/azure_ora_nfile_migration.html#converting-a-single-instance-non-cdb-to-a-pdb-in-a-multitenant-cdb["Migrazione del database dal cloud on-premise al cloud Azure"^] per il percorso di migrazione del database.
...
[%collapsible]
====
NetApp consiglia il tool dell'interfaccia utente di SnapCenter per gestire i database Oracle implementati nel cloud Azure. Consulta il documento TR-4988: link:https://docs.netapp.com/us-en/netapp-solutions/databases/snapctr_ora_azure_anf.html["Backup, ripristino e cloning di database Oracle su ANF con SnapCenter"^] per ulteriori informazioni.
...
+
link:https://docs.netapp.com/us-en/netapp-solutions/databases/snapctr_ora_azure_anf.html["Backup, ripristino e cloning di database Oracle su ANF con SnapCenter"^]
