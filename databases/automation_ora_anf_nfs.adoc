...
[%collapsible]
====
NetApp consiglia il tool dell'interfaccia utente di SnapCenter per gestire i database Oracle implementati nel cloud Azure. A breve sarà disponibile una documentazione dettagliata sulla soluzione.
