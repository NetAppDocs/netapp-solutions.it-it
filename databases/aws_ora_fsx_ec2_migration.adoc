...
link:https://docs.netapp.com/us-en/netapp-solutions/media/oracle-aws-fsx-part2b-migration-snapmirror_callout.mp4["Migrazione di database Oracle da on-premise a FSX/EC2 tramite SnapMirror e BlueXP"^]
