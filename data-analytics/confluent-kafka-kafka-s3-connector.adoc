...
link:confluent-kafka-performance-tests-with-scalability.html["Precedente: Test delle performance con scalabilità."]
...
link:confluent-kafka-confluent-kafka-rebalance.html["Avanti: Cluster di auto-ribilanciamento confluenti."]
