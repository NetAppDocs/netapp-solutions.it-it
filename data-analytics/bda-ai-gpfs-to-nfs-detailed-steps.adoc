...
summary: In questa sezione vengono fornite le procedure dettagliate necessarie per configurare GPFS e spostare i dati in NFS utilizzando NetApp XCP. 
---
...
link:bda-ai-business-benefits.html["Precedente: Benefici per il business."]
...
. Scaricare e installare Spectrum Scale Data Access per Linux su uno dei server.
+
....
...
…
....
. Installare il pacchetto prerequisito (inclusi chef e kernel header) su tutti i nodi.
+
....
...
....
. Disattivare SELinux in tutti i nodi.
+
....
...
[root@mastr-51 installer]#
....
. Aggiungere il nodo manager e il nodo GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Aggiungere un altro server GUI.
+
....
...
[root@mastr-51 installer]#
....
. Specificare un nome del cluster nel file di definizione del cluster.
+
....
...
....
. Specificare il binario della shell remota che deve essere utilizzato da GPFS; use `-r argument`.
+
....
...
[root@mastr-51 installer]#
....
. Specificare il binario di copia del file remoto da utilizzare da GPFS; Use `-rc argument`.
+
....
...
[root@mastr-51 installer]#
....
. Visualizzare le impostazioni di configurazione di GPFS.
+
....
...
[root@mastr-51 installer]#
....
. Controllare le configurazioni prima dell'installazione.
+
....
...
[root@mastr-51 cluster-test]#
....
. Controllare e fornire le autorizzazioni necessarie per GPFS.
+
....
...
[root@mastr-51 cluster-test]#
....
. Controllare la lettura e la scrittura della GPFS eseguendo `dd` comando.
+
....
...
[root@mastr-51 ~]#
....
. Elencare i file in GPFS per convalidare il client NFS.
+
....
...
[root@hdp2 ~]#
....
. Convalidare l'elenco dei file GPFS nella cartella montata su NFS.
+
....
...
[root@hdp2 gpfstest]#
....
. Spostare i dati dal file NFS esportato con GPFS al NetApp NFS utilizzando XCP.
+
....
...
link:bda-ai-mapr-fs-to-ontap-nfs.html["Avanti: Da MapR-FS a NFS ONTAP."]
