...
link:confluent-kafka-confluent-kafka-certification.html["Precedente: Verifica confluente."]
...
link:confluent-kafka-kafka-s3-connector.html["Successivo: Connettore s3 confluente."]
