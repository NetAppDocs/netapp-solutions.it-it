...
Per ottenere le migliori performance, NetApp consiglia di utilizzare più interfacce di rete e connessioni dirette o percorsi espressi per accedere ai dati dalle istanze cloud. Abbiamo altre soluzioni di data mover, tra cui https://mysupport.netapp.com/documentation/docweb/index.html?productID=63942&language=en-US["XCP"^] e. https://cloud.netapp.com/cloud-sync-service["Cloud Sync"^] Per aiutare i clienti a creare cluster Spark di cloud ibrido basati su applicazioni, sicuri e convenienti.
