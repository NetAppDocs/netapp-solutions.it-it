...
link:xcp-bp-duplicate-files.html["Precedente: File duplicati."]
...
c:\XCP>
....
link:xcp-bp-creating-a-csv-file-from-smb-cifs-share.html["Avanti: Creazione di un file CSV da una condivisione SMB/CIFS."]
