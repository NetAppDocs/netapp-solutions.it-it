...
link:xcp-bp-data-migration-from-7-mode-to-ontap.html["Precedente: Migrazione dei dati da 7-Mode a ONTAP."]
...
link:xcp-bp-best-practice-guidelines-and-recommendations.html["Segue: Linee guida e consigli sulle Best practice."]
