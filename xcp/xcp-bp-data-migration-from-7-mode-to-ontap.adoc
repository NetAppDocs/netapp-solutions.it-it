...
link:xcp-bp-creating-a-csv-file-from-smb-cifs-share.html["Precedente: Creazione di un file CSV da una condivisione SMB/CIFS."]
...
link:xcp-bp-cifs-data-migration-with-acls-from-a-source-storage-box-to-ontap.html["Segue: Migrazione dei dati CIFS con ACL da un storage box di origine a ONTAP."]
