...
link:xcp-bp-migration-workflow-overview.html["Precedente: Workflow di migrazione."]
...
image:xcp-bp_image6.png["Errore: Immagine grafica mancante"]
...
image:xcp-bp_image7.png["Errore: Immagine grafica mancante"]

link:xcp-bp-deployment-steps.html["Avanti: Fasi di implementazione."]
