...
* *Utilizzare gli strumenti ONTAP per distribuire gli archivi dati vVol (iSCSI) in un dominio del carico di lavoro VI*. Fare clic su https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_wkld_vvols.html["*qui*"] per le fasi di implementazione.
...
* *Distribuire e utilizzare il plug-in SnapCenter per VMware vSphere per proteggere e ripristinare le VM in un dominio del carico di lavoro VI*. Fare clic su https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_scv_wkld.html["*qui*"] per le fasi di implementazione.
