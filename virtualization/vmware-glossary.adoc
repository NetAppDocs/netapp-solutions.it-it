...
* link:../ehc/aws/aws-migrate-vmware-hcx.html["Migra i carichi di lavoro nel datastore FSX ONTAP utilizzando VMware HCX"]
* link:../ehc/azure/azure-migrate-vmware-hcx.html["Migra i carichi di lavoro nel datastore Azure NetApp Files utilizzando VMware HCX"]
* link:../ehc/gcp/gcp-migrate-vmware-hcx.html["Migra i carichi di lavoro nel datastore di NetApp Cloud Volume Service su Google Cloud VMware Engine utilizzando VMware HCX"]
...
* link:../containers/tanzu_with_netapp/vtwn_solution_overview.html["Soluzioni NetApp per VMware Tanzu"]
...
* link:../ehc/aws/index.html["Soluzioni NetApp per AWS VMware Cloud (VMC)"]
* link:../ehc/azure/index.html["Soluzioni NetApp per Azure VMware Solution (AVS)"]
* link:../ehc/gcp/index.html["Soluzioni NetApp per Google Cloud VMware Engine (GCVE)"]
