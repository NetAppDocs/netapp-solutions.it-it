...
* Distribuire i domini del carico di lavoro VCF VI utilizzando ONTAP come storage principale (NFS, vVol).
...
* *Configurare e utilizzare un datastore NFS come storage principale durante la distribuzione del dominio del carico di lavoro VI.* fare clic link:https://review.docs.netapp.com/us-en/netapp-solutions_vcf_asa_aff/virtualization/vsphere_ontap_auto_block_fc.html["*QUI*"] per le fasi di implementazione. Fare clic su link:https://review.docs.netapp.com/us-en/netapp-solutions_vcf_asa_aff/virtualization/vsphere_ontap_auto_block_fc.html["*QUI*"]
* *Configurare e utilizzare un datastore vVol come storage principale durante la distribuzione del dominio del carico di lavoro VI.* fare clic sul collegamento:
* *Installare e dimostrare l'uso degli strumenti ONTAP per configurare e montare gli archivi dati NFS come archiviazione supplementare nei domini del carico di lavoro VI.* fare clic su link:link:https://review.docs.netapp.com/us-en/netapp-solutions_vcf_asa_aff/virtualization/vsphere_ontap_auto_block_fc.html["*QUI*"]
