...
permalink: vmware/tr-4792.html
Parole chiave: Design, HCI, computing, vmware, cloud, grafica, virtualizzazione
riepilogo: "TR-4792 fornisce indicazioni per l'utilizzo di NetApp HCI 615C per i workload di grafica 3D in un ambiente VMware Horizon con le GPU (Graphics Processing Unit) e il software di virtualizzazione NVIDIA".
---
