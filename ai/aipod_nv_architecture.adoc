...
_Topologia soluzione AIpod NetApp_ image:aipod_nv_a900topo.png[""]
...
_Configurazione logica cluster di archiviazione NetApp A900_ image:aipod_nv_A900logical.png[""]
