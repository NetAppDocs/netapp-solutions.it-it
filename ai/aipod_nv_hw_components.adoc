...
Parole chiave: NetApp ai, ai, intelligenza artificiale, ML, machine learning, NVIDIA, NVIDIA AI ENTERPRISE, NVIDIA BASEPOD, NVIDIA DGX
riepilogo: NetApp FlexPod con sistemi NVIDIA DGX - componenti hardware
