...
link:ai-sent-use-cases.html["Precedente: Casi di utilizzo."]
...
image:ai-sent-image4.png["Errore: Immagine grafica mancante"]
...
https://docs.netapp.com/us-en/occm/concept_cloud_sync.html["Cloud Sync"^] È un servizio NetApp per una sincronizzazione dei dati rapida e sicura che consente di trasferire file tra condivisioni di file NFS o SMB on-premise a una delle seguenti destinazioni:
...
Cloud Sync sposta i file dove servono in modo rapido e sicuro. Una volta trasferiti, i dati sono completamente disponibili per l'utilizzo sia sull'origine che sulla destinazione. Cloud Sync sincronizza continuamente i dati, in base alla pianificazione predefinita, spostando solo i delta, in modo da ridurre al minimo il tempo e il denaro speso per la replica dei dati. Cloud Sync è uno strumento SaaS (Software as a Service) semplice da configurare e utilizzare. I trasferimenti di dati attivati da Cloud Sync vengono eseguiti da broker di dati. Puoi implementare i data broker Cloud Sync in AWS, Azure, piattaforma cloud Google o on-premise.
...
image:ai-sent-image6.png["Errore: Immagine grafica mancante"]
...
image:ai-sent-image8.png["Errore: Immagine grafica mancante"]
...
link:ai-sent-design-considerations.html["Segue: Considerazioni di progettazione."]
