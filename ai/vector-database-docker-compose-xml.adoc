...
summary: docker-compose.xml - soluzione database vettoriale per NetApp 
---
...
[role="lead"]
In questa sezione è incluso il codice YAML di esempio per la soluzione di database vettoriale per NetApp.
