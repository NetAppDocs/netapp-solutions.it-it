...
• Fornire rapidamente nuovi spazi di lavoro JupyterLab ad alta capacità, supportati dallo storage NetApp scale-out dalle performance elevate.
• Esegui il provisioning rapido delle nuove istanze di NVIDIA Triton Inference Server supportate dallo storage NetApp di livello Enterprise.
• Clonazione quasi istantanea di aree di lavoro JupyterLab ad alta capacità per consentire la sperimentazione o l'iterazione rapida.
• Consente di salvare quasi istantaneamente istantanee di spazi di lavoro JupyterLab ad alta capacità per backup e/o tracciabilità/baseline.
• Eseguire il provisioning quasi istantaneo, clonare e Snapshot su volumi di dati a elevata capacità e dalle performance elevate.
