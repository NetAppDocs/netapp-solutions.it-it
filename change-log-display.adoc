...
| 2025-06-30 | Database | Nuovo toolkit di automazione: "Ciclo di vita automatizzato di clonazione Oracle VLDB con backup delle immagini nel server" 


| 2025-06-09 | Database | Nuovo TR-5007: "Ottimizzare il backup e il ripristino di Oracle VLDB con l'unione incrementale in-server su volumi Google Cloud NetApp" 
