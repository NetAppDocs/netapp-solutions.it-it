...
[cols="10%, 30%, 60%"]
|===
| *Data* | *Area soluzione* | *Descrizione del cambiamento* / tag::ent-db[] 
...
| 05/14/2024 | Virtualizzazione | Aggiunta migrazione di VM ad Amazon EC2 utilizzando i contenuti FSxN 
