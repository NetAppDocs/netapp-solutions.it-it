...
* Trident deve essere già installato e configurato in ciascuno dei cluster Kubernetes di Tanzu.
...
* Una classe di storage predefinita configurata su ogni cluster Kubernetes Tanzu con Trident come provisioner di storage.
