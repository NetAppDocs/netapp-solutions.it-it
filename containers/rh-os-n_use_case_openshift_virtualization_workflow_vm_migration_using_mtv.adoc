...
[role="lead"]
In questa sezione viene descritto come migrare una macchina virtuale tra cluster utilizzando il toolkit di migrazione Red Hat OpenShift Virtualization.
