...
**Backend Trident per iSCSI** file yaml di esempio per creare la configurazione backend Trident per lo storage san ONTAP con protocollo iSCSI
...
spec:
  ...
  credentials:
    name: backend-tbc-ontap-san-secret
----
**Classe di archiviazione Trident per iSCSI** file yaml di esempio per creare la configurazione della classe di archiviazione Trident per l'archiviazione san ONTAP con protocollo iSCSI
...
----
**Installazione del backend FC e della classe di archiviazione** file yaml di esempio per creare la configurazione back-end Trident per lo storage san ONTAP con protocollo FC
...
spec:
  ...
  credentials:
    name: tbc-fc-secret
----
File yaml di esempio per creare la configurazione della classe di archiviazione Trident per lo storage san ONTAP con protocollo FC **Classe di archiviazione Trident per FC**
