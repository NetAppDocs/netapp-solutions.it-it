...
L'ultima versione di Trident è 22,01 rilasciata a gennaio 2022. Una matrice di supporto per quale versione di Trident è stata testata con quale distribuzione Kubernetes può essere trovata https://docs.netapp.com/us-en/trident/trident-get-started/requirements.html#supported-frontends-orchestrators["qui"].
