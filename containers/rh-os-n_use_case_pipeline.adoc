...
+
image:redhat_openshift_image15.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
+
image:redhat_openshift_image19.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
+
image:redhat_openshift_image22.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]

. Autorizzare l'account del servizio Jenkins ad accedere agli utenti OpenShift.
+
image:redhat_openshift_image23.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
...
+
image:redhat_openshift_image25.jpeg["Figura che mostra la finestra di dialogo input/output o rappresenta il contenuto scritto"]
