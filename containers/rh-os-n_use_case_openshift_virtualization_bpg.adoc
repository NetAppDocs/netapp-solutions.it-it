...
I dettagli sulla migrazione delle VM da vSphere sono disponibili in link:https://docs.netapp.com/us-en/netapp-solutions/containers/rh-os-n_use_case_openshift_virtualization_workflow_vm_migration_using_mtv.html["Flussi di lavoro > virtualizzazione Red Hat OpenShift con NetApp ONTAP"]
