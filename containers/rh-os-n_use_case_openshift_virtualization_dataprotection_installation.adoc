...
Immagine::redhat_openshift_OADP_install_image6.jpg[Create Segreto per le credenziali utente di S3 utilizzando CLI]
...
Immagine::redhat_openshift_OADP_install_image7.jpg[DataProtectionApplication]
...
Immagine::redhat_openshift_OADP_install_image8.jpg[Create DataProtectionApplication]
  ...
  configuration:
    ...
    velero:
      defaultPlugins:
        ...
        - kubevirt
....
I file YAML di cui sopra presentano le seguenti sezioni nella specifica configurate in modo appropriato simile agli esempi precedenti
...
Immagine::viene creato un oggetto redhat_openshift_OADP_install_image11.jpg[DataProtectionApplication]
...
Immagine::redhat_openshift_OADP_install_image12.jpg[BackupStorageLocation creata]
