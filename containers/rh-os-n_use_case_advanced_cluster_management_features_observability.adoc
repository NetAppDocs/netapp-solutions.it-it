...
+
image:redhat_openshift_image82.png["Pagina iniziale dell'osservabilità"]
...
+
image:redhat_openshift_image83.png["Osservare i pod"]
...
+
image:redhat_openshift_image84.png["Osservare i nodi"]
...
+
image:redhat_openshift_image85.png["Osservare i Clusters"]
