...
image::gcve-deploy-1.png[gcve distribuire 1]
...
image::gcve-access-1.png[accesso gcve 1]
...
image::gcve-access-2.png[accesso gcve 2]
...
image::gcve-access-3.png[accesso gcve 3]

image::gcve-access-4.png[accesso gcve 4]
