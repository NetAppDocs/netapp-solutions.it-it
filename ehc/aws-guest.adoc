...
image::aws-fsx-guest-1.png[aws fsx guest 1]
...
image::aws-fsx-guest-2.png[aws fsx guest 2]
...
image::aws-fsx-guest-3.png[aws fsx guest 3]

. Nella sezione rete, per Virtual Private Cloud (VPC), scegliere le subnet VPC e preferite appropriate insieme alla tabella di routing. In questo caso, vmcfsx2.vpc viene selezionato dal menu a discesa.


image::aws-fsx-guest-4.png[aws fsx guest 4]
...
image::aws-fsx-guest-5.png[aws fsx guest 5]
...
image::aws-fsx-guest-6.png[aws fsx guest 6]
...
image::aws-fsx-guest-7.png[aws fsx guest 7]
...
image::aws-fsx-guest-8.png[aws fsx guest 8]

image::aws-fsx-guest-9.png[aws fsx guest 9]

image::aws-fsx-guest-10.png[aws fsx guest 10]
...
image::aws-fsx-guest-11.png[aws fsx guest 11]
...
image::aws-fsx-guest-20.png[aws fsx guest 20]

. Una volta eseguito, eseguire il comando df per convalidare il mount.


image::aws-fsx-guest-21.png[aws fsx guest 21]
...
image::aws-fsx-guest-22.png[aws fsx guest 22]
...
image::aws-fsx-guest-23.png[aws fsx guest 23]

. A questo punto, scegliere una nuova condivisione e completare la procedura guidata Crea una cartella condivisa.


image::aws-fsx-guest-24.png[aws fsx guest 24]

image::aws-fsx-guest-25.png[aws fsx guest 25]
...
image::aws-fsx-guest-26.png[aws fsx guest 26]
...
image::aws-fsx-guest-30.png[aws fsx guest 30]
...
image::aws-fsx-guest-31.png[aws fsx guest 31]
...
image::aws-fsx-guest-32.png[aws fsx guest 32]
...
image::aws-cvo-guest-1.png[aws cvo ospite 1]
...
image::aws-cvo-guest-2.png[aws cvo ospite 2]
...
image::aws-cvo-guest-3.png[aws cvo ospite 3]
...
image::aws-cvo-guest-7.png[aws cvo ospite 7]

. Specificare gli indirizzi IP mobili, quindi fare clic su Continue (continua).


image::aws-cvo-guest-8.png[aws cvo ospite 8]
...
image::aws-cvo-guest-11.png[aws cvo ospite 11]
...
image::aws-cvo-guest-12.png[aws cvo ospite 12]
...
image::aws-cvo-guest-20.png[aws cvo ospite 20]
...
image::aws-cvo-guest-21.png[aws cvo ospite 21]
...
image::aws-cvo-guest-22.png[aws cvo ospite 22]
...
image::aws-cvo-guest-23.png[aws cvo ospite 23]

image::aws-cvo-guest-24.png[aws cvo ospite 24]
...
image::aws-cvo-guest-30.png[aws cvo ospite 30]

image::aws-cvo-guest-31.png[aws cvo ospite 31]
...
image::aws-cvo-guest-32.png[aws cvo ospite 32]
...
image::aws-cvo-guest-33.png[aws cvo ospite 33]
...
image::aws-cvo-guest-34.png[aws cvo ospite 34]
...
image::aws-cvo-guest-40.png[aws cvo ospite 40]

image::aws-cvo-guest-41.png[aws cvo ospite 41]
